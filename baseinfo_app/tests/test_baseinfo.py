...
class BaseinfoTest(APITestCase):
    ...
    def setUp(self):
        ...
        self.offer = Offers.objects.create(title='test', description='dies ist eine test beschreibung', user=self.user,)
        ...
        self.review = Reviews.objects.create(business_user=self.business_user, reviewer=self.user, rating=5, description='geil gemacht')
